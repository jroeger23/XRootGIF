...
VERSION=1.3
CC= gcc
DEFINES= -D VERSION=\"$(VERSION)\" -D HAVE_XRANDR
LIBRARIES= -lX11 -lgif -lImlib2 -lXrandr -lXinerama
CFLAGS = -Wall -zrelro -znow
